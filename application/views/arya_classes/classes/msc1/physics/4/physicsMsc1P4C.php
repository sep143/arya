    ...
    <div class="main-content-inner">
        ...
        <div class="breadcrumbs ace-save-state responsive" id="breadcrumbs">
            <ul class="breadcrumb pull-left">
                <li>
                 ...
                 <li>
                    <i class="ace-icon fa fa-home home-icon"></i>
                    <a href="<?= site_url('SearchController/physicsMsc1All');?>">Physics Msc Previous Year Students</a>
                </li>
                <li>Physics Msc Previous Year 4th Paper Student</li>
            </ul><!-- /.breadcrumb -->
        ...
        <div class="page-content">
            <div class="page-header">
                ...
                <h1>Msc Previous Year Physics 4th Paper C Batch Students
                    <div class="dropdown pull-right responsive">
                        <button class="btn btn-primary dropdown-toggle btn-xs" type="button" data-toggle="dropdown">P-P-4
                            <span class="caret"></span></button>
                        <ul class="dropdown-menu">
                            <li><a href="<?= site_url('BatchController/physicsMsc1P4A'); ?>">A</a></li>
                            <li><a href="<?= site_url('BatchController/physicsMsc1P4B'); ?>">B</a></li>
                            <li><a href="<?= site_url('BatchController/physicsMsc1P4C'); ?>">C</a></li>
                            <li><a href="<?= site_url('BatchController/physicsMsc1P4D'); ?>">D</a></li>
                            <li><a href="<?= site_url('BatchController/physicsMsc1P4E'); ?>">E</a></li>
                        </ul>
                    </div>
                </h1>
            </div><!-- /.page-header -->
