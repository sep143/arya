    ...
    <div class="main-content-inner">
        ...
        <div class="breadcrumbs ace-save-state responsive" id="breadcrumbs">
            <ul class="breadcrumb pull-left">
                ...
                <li>Physics Msc Previous Year 3rd Paper Student</li>
            </ul><!-- /.breadcrumb -->
        ...
        <div class="page-content">
            <div class="page-header">
                ...
                <h1>Msc Previous Year Physics 3rd Paper C Batch Students 
                    <div class="dropdown pull-right responsive">
                        <button class="btn btn-primary dropdown-toggle btn-xs" type="button" data-toggle="dropdown">P-P-3
                            <span class="caret"></span></button>
                        <ul class="dropdown-menu">
                            <li><a href="<?= site_url('BatchController/physicsMsc1P3A'); ?>">A</a></li>
                            <li><a href="<?= site_url('BatchController/physicsMsc1P3B'); ?>">B</a></li>
                            <li><a href="<?= site_url('BatchController/physicsMsc1P3C'); ?>">C</a></li>
                            <li><a href="<?= site_url('BatchController/physicsMsc1P3D'); ?>">D</a></li>
                            <li><a href="<?= site_url('BatchController/physicsMsc1P3E'); ?>">E</a></li>
                        </ul>
                    </div>
                </h1>
            </div><!-- /.page-header -->
