       ...
       <div class="breadcrumbs ace-save-state responsive" id="breadcrumbs">
            <ul class="breadcrumb pull-left">
                <li>
                 ...
                 <li>
                    <i class="ace-icon fa fa-home home-icon"></i>
                    <a href="<?= site_url('SearchController/mathsMsc1All');?>">Maths Msc Previous Year Students</a>
                </li>
                <li>Maths Msc Previous Year 5th Paper Students</li>
            </ul><!-- /.breadcrumb -->
        ...
        <div class="page-content">
            <div class="page-header">
                ...
                <h1>Maths Msc Previous Year 5th Paper B Batch Students
                    <div class="dropdown pull-right responsive">
                        <button class="btn btn-primary dropdown-toggle btn-xs" type="button" data-toggle="dropdown">M-P-5
                            <span class="caret"></span></button>
                        <ul class="dropdown-menu">
                            <li><a href="<?= site_url('BatchController/mathsMsc1P5A'); ?>">A</a></li>
                            <li><a href="<?= site_url('BatchController/mathsMsc1P5B'); ?>">B</a></li>
                            <li><a href="<?= site_url('BatchController/mathsMsc1P5C'); ?>">C</a></li>
                            <li><a href="<?= site_url('BatchController/mathsMsc1P5D'); ?>">D</a></li>
                            <li><a href="<?= site_url('BatchController/mathsMsc1P5E'); ?>">E</a></li>
                        </ul>
                    </div>
                </h1>
            </div><!-- /.page-header -->
