    ...
    <div class="main-content-inner">
        ...
        <div class="breadcrumbs ace-save-state responsive" id="breadcrumbs">
            <ul class="breadcrumb pull-left">
                ...
                <li>
                    <i class="ace-icon fa fa-home home-icon"></i>
                    <a href="<?= site_url('SearchController/chemistryBsc3All');?>">Chemistry Bsc 3<sup>rd</sup> Year Students</a>
                </li>
                <li>Chemistry Paper 3<sup>rd</sup> Students</li>
            </ul><!-- /.breadcrumb -->
        ...
        <div class="page-content">
            <div class="page-header">
                ...
                <h1>Bsc 3 Year Chemistry 3rd Paper C Batch Students
                     <div class="dropdown pull-right responsive">
                        <button class="btn btn-primary dropdown-toggle btn-xs" type="button" data-toggle="dropdown">C-P-3
                            <span class="caret"></span></button>
                        <ul class="dropdown-menu">
                            <li><a href="<?= site_url('BatchController/chemistryBsc3P3A'); ?>">A</a></li>
                            <li><a href="<?= site_url('BatchController/chemistryBsc3P3B'); ?>">B</a></li>
                            <li><a href="<?= site_url('BatchController/chemistryBsc3P3C'); ?>">C</a></li>
                            <li><a href="<?= site_url('BatchController/chemistryBsc3P3D'); ?>">D</a></li>
                            <li><a href="<?= site_url('BatchController/chemistryBsc3P3E'); ?>">E</a></li>
                        </ul>
                    </div>
                </h1>
            </div><!-- /.page-header -->
