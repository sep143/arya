    ...
    <div class="main-content-inner">
        ...
        <div class="breadcrumbs ace-save-state responsive" id="breadcrumbs">
            <ul class="breadcrumb pull-left">
                ...
                <li>
                    <i class="ace-icon fa fa-home home-icon"></i>
                    <a href="<?= site_url('SearchController/physicsBsc3All');?>">Physics Bsc 3<sup>rd</sup> Year Students</a>
                </li>
        ...
        <div class="page-content">
            <div class="page-header">
                ...
                <h1>Bsc 3 Year Physics 3rd Paper B Batch Students
                    <div class="dropdown pull-right responsive">
                        <button class="btn btn-primary dropdown-toggle btn-xs" type="button" data-toggle="dropdown">P-P-3
                            <span class="caret"></span></button>
                        <ul class="dropdown-menu">
                            <li><a href="<?= site_url('BatchController/physicsBsc3P3A'); ?>">A</a></li>
                            <li><a href="<?= site_url('BatchController/physicsBsc3P3B'); ?>">B</a></li>
                            <li><a href="<?= site_url('BatchController/physicsBsc3P3C'); ?>">C</a></li>
                            <li><a href="<?= site_url('BatchController/physicsBsc3P3D'); ?>">D</a></li>
                            <li><a href="<?= site_url('BatchController/physicsBsc3P3E'); ?>">E</a></li>
                        </ul>
                    </div>
                </h1>
            </div><!-- /.page-header -->
