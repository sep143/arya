                    ...
                    <table class="table table-bordered table-hover table-responsive" id="dataTables">
                        ...
                        <tbody>
                            ...
                            foreach ($result as $row) {
                                ...
                                else if ($row->subject == 20) {
                                    echo "<td>Chemistry</td>";
                                }
                                else if ($row->subject == 21) {
                                    echo "<td>Maths</td>";
                                }else{
                                    echo "<td>Null</td>";
                                }
                                //paper row
                                if(($row->paper ==57||$row->paper ==62||$row->paper ==67)){
                                    echo "<td>Paper I</td>";
                                }else if (($row->paper ==58||$row->paper ==63||$row->paper ==68)) {
                                    echo "<td>Paper II</td>";
                                }else if(($row->paper ==59||$row->paper ==64||$row->paper ==69)){
                                    echo "<td>Paper III</td>";
                                }
                                else if(($row->paper ==60||$row->paper ==65||$row->paper ==70)){
                                    echo "<td>Paper IV</td>";
                                }
                                else if(($row->paper ==61||$row->paper ==66||$row->paper ==71)){
                                    echo "<td>Paper V</td>";
                                }else{
                                    echo "<td>Null</td>";
                                }
