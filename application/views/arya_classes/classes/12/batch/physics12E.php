    ...
    <div class="main-content-inner">
        ...
        <div class="page-content">
            <div class="page-header">
                ...
                <h1>Physics 12th E Batch Students
            <div class="dropdown pull-right responsive">
                    <button class="btn btn-primary dropdown-toggle btn-xs" type="button" data-toggle="dropdown">Batch
                    <span class="caret"></span></button>
                <ul class="dropdown-menu">
                   <li><a href="<?= site_url('BatchController/physics12A');?>">A</a></li>
                    <li><a href="<?= site_url('BatchController/physics12B');?>">B</a></li>
                    <li><a href="<?= site_url('BatchController/physics12C');?>">C</a></li>
                    <li><a href="<?= site_url('BatchController/physics12D');?>">D</a></li>
                    <li><a href="<?= site_url('BatchController/physics12E');?>">E</a></li>
                </ul>
            </div>
                </h1>
            </div><!-- /.page-header -->
