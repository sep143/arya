    ...
    <div class="main-content-inner">
        ...
        <div class="page-content">
            <div class="page-header">
                ...
                <h1>Physics C Batch NET-JRF Students
                    <div class="dropdown pull-right responsive">
                        <button class="btn btn-primary dropdown-toggle btn-xs" type="button" data-toggle="dropdown">Batch
                            <span class="caret"></span></button>
                        <ul class="dropdown-menu">
                            <li><a href="<?= site_url('BatchController/physicsNetA'); ?>">A</a></li>
                            <li><a href="<?= site_url('BatchController/physicsNetB'); ?>">B</a></li>
                            <li><a href="<?= site_url('BatchController/physicsNetC'); ?>">C</a></li>
                            <li><a href="<?= site_url('BatchController/physicsNetD'); ?>">D</a></li>
                            <li><a href="<?= site_url('BatchController/physicsNetE'); ?>">E</a></li>
                        </ul>
                    </div>
                </h1>
            </div><!-- /.page-header -->
