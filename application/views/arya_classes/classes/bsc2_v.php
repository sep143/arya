    ...
    <div class="main-content-inner">
        ...
        <div class="breadcrumbs ace-save-state responsive" id="breadcrumbs">
            <ul class="breadcrumb pull-left">
                ...
                <li>Bsc 2<sup>nd</sup> Year Students</li>
            </ul><!-- /.breadcrumb -->
                    ...
                    <table class="table table-bordered table-hover table-responsive" id="dataTables">
                        ...
                        <tbody>
                            ...
                            foreach ($result as $row) {
                                ...
                                else if ($row->subject == 14) {
                                    echo "<td>Chemistry</td>";
                                }
                                else if ($row->subject == 15) {
                                    echo "<td>Maths</td>";
                                }else{
                                    echo "<td>Null</td>";
                                }
                                //paper row
                                if(($row->paper ==24||$row->paper ==27||$row->paper ==30)){
                                    echo "<td>Paper I</td>";
                                }else if (($row->paper ==25||$row->paper ==28||$row->paper ==31)) {
                                    echo "<td>Paper II</td>";
                                }else if(($row->paper ==26||$row->paper ==29||$row->paper ==32)){
