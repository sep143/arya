    ...
    <div class="main-content-inner">
       ...
       <div class="breadcrumbs ace-save-state responsive" id="breadcrumbs">
            <ul class="breadcrumb pull-left">
                ...
                <li>Maths Msc Final Year 2st Paper Students</li>
            </ul><!-- /.breadcrumb -->
        ...
        <div class="page-content">
            <div class="page-header">
                ...
                <h1>Maths Msc Final Year 2nd Paper A Batch Students
                    <div class="dropdown pull-right responsive">
                        <button class="btn btn-primary dropdown-toggle btn-xs" type="button" data-toggle="dropdown">M-P-2
                            <span class="caret"></span></button>
                        <ul class="dropdown-menu">
                            <li><a href="<?= site_url('BatchController/mathsMsc2P2A'); ?>">A</a></li>
                            <li><a href="<?= site_url('BatchController/mathsMsc2P2B'); ?>">B</a></li>
                            <li><a href="<?= site_url('BatchController/mathsMsc2P2C'); ?>">C</a></li>
                            <li><a href="<?= site_url('BatchController/mathsMsc2P2D'); ?>">D</a></li>
                            <li><a href="<?= site_url('BatchController/mathsMsc2P2E'); ?>">E</a></li>
                        </ul>
                    </div>
                </h1>
            </div><!-- /.page-header -->
