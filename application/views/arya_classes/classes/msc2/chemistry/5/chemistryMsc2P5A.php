    ...
    <div class="main-content-inner">
        ...
        <div class="breadcrumbs ace-save-state responsive" id="breadcrumbs">
            <ul class="breadcrumb pull-left">
                <li>
                 ...
                 <li>
                    <i class="ace-icon fa fa-home home-icon"></i>
                    <a href="<?= site_url('SearchController/chemistryMsc2All');?>">Chemistry Msc Final Year Students</a>
                </li>
                <li>Chemistry Paper 5<sup>th</sup> Students</li>
            </ul><!-- /.breadcrumb -->
        ...
        <div class="page-content">
            <div class="page-header">
                ...
                <h1>Chemistry Msc Final Year 5th Paper A Batch Students
                    <div class="dropdown pull-right responsive">
                        <button class="btn btn-primary dropdown-toggle btn-xs" type="button" data-toggle="dropdown">C-P-5
                            <span class="caret"></span></button>
                        <ul class="dropdown-menu">
                            <li><a href="<?= site_url('BatchController/chemistryMsc2P5A'); ?>">A</a></li>
                            <li><a href="<?= site_url('BatchController/chemistryMsc2P5B'); ?>">B</a></li>
                            <li><a href="<?= site_url('BatchController/chemistryMsc2P5C'); ?>">C</a></li>
                            <li><a href="<?= site_url('BatchController/chemistryMsc2P5D'); ?>">D</a></li>
                            <li><a href="<?= site_url('BatchController/chemistryMsc2P5E'); ?>">E</a></li>
                        </ul>
                    </div>
                </h1>
            </div><!-- /.page-header -->
