    ...
    <div class="main-content-inner">
        ...
        <div class="breadcrumbs ace-save-state responsive" id="breadcrumbs">
            <ul class="breadcrumb pull-left">
                <li>
                 ...
                 <li>
                    <i class="ace-icon fa fa-home home-icon"></i>
                    <a href="<?= site_url('SearchController/physicsMsc2All');?>">Physics Msc Final Year Students</a>
                </li>
                <li>Physics Msc Final Year 3rd Paper Student</li>
            </ul><!-- /.breadcrumb -->
        ...
        <div class="page-content">
            <div class="page-header">
                ...
                <h1>Msc Final Year Physics 3rd Paper D Batch Students
                    <div class="dropdown pull-right responsive">
                        <button class="btn btn-primary dropdown-toggle btn-xs" type="button" data-toggle="dropdown">P-P-3
                            <span class="caret"></span></button>
                        <ul class="dropdown-menu">
                            <li><a href="<?= site_url('BatchController/physicsMsc2P3A'); ?>">A</a></li>
                            <li><a href="<?= site_url('BatchController/physicsMsc2P3B'); ?>">B</a></li>
                            <li><a href="<?= site_url('BatchController/physicsMsc2P3C'); ?>">C</a></li>
                            <li><a href="<?= site_url('BatchController/physicsMsc2P3D'); ?>">D</a></li>
                            <li><a href="<?= site_url('BatchController/physicsMsc2P3E'); ?>">E</a></li>
                        </ul>
                    </div>
                </h1>
            </div><!-- /.page-header -->
