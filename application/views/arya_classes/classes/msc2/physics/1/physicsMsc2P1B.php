    ...
    <div class="main-content-inner">
        ...
        <div class="breadcrumbs ace-save-state responsive" id="breadcrumbs">
            <ul class="breadcrumb pull-left">
                ...
                <li>Physics Msc Final Year 1st Paper Student</li>
            </ul><!-- /.breadcrumb -->
        ...
        <div class="page-content">
            <div class="page-header">
                ...
                <h1>Msc Final Year Physics 1st Paper B Batch Students
                    <div class="dropdown pull-right responsive">
                        <button class="btn btn-primary dropdown-toggle btn-xs" type="button" data-toggle="dropdown">P-P-1
                            <span class="caret"></span></button>
                        <ul class="dropdown-menu">
                            <li><a href="<?= site_url('BatchController/physicsMsc2P1A'); ?>">A</a></li>
                            <li><a href="<?= site_url('BatchController/physicsMsc2P1B'); ?>">B</a></li>
                            <li><a href="<?= site_url('BatchController/physicsMsc2P1C'); ?>">C</a></li>
                            <li><a href="<?= site_url('BatchController/physicsMsc2P1D'); ?>">D</a></li>
                            <li><a href="<?= site_url('BatchController/physicsMsc2P1E'); ?>">E</a></li>
                        </ul>
                    </div>
                </h1>
            </div><!-- /.page-header -->
