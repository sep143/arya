    ...
    <div class="main-content-inner">
        ...
        <div class="page-content">
            <div class="page-header">
                ...
                <h1>Chemistry 11th Students
                <div class="dropdown pull-right responsive">
                    <button class="btn btn-primary dropdown-toggle btn-xs" type="button" data-toggle="dropdown">Batch
                    <span class="caret"></span></button>
                <ul class="dropdown-menu">
                    <li><a href="<?= site_url('BatchController/chemistry11A');?>">A</a></li>
                    <li><a href="<?= site_url('BatchController/chemistry11B');?>">B</a></li>
                    <li><a href="<?= site_url('BatchController/chemistry11C');?>">C</a></li>
                    <li><a href="<?= site_url('BatchController/chemistry11D');?>">D</a></li>
                    <li><a href="<?= site_url('BatchController/chemistry11E');?>">E</a></li>
                </ul>
            </div>
                </h1>
            </div><!-- /.page-header -->
