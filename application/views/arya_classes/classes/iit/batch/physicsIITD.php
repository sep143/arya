    ...
    <div class="main-content-inner">
        ...
        <div class="page-content">
            <div class="page-header">
                ...
                <h1>Physics D Batch IIT Students
                     <div class="dropdown pull-right responsive">
                    <button class="btn btn-primary dropdown-toggle btn-xs" type="button" data-toggle="dropdown">Batch
                    <span class="caret"></span></button>
                <ul class="dropdown-menu">
                    <li><a href="<?= site_url('BatchController/physicsIITA');?>">A</a></li>
                    <li><a href="<?= site_url('BatchController/physicsIITB');?>">B</a></li>
                    <li><a href="<?= site_url('BatchController/physicsIITC');?>">C</a></li>
                    <li><a href="<?= site_url('BatchController/physicsIITD');?>">D</a></li>
                    <li><a href="<?= site_url('BatchController/physicsIITE');?>">E</a></li>
                </ul>
            </div>
                </h1>
            </div><!-- /.page-header -->
