    ...
    <div class="main-content-inner">
        ...
        <div class="breadcrumbs ace-save-state responsive" id="breadcrumbs">
            <ul class="breadcrumb pull-left">
                ...
                <li>
                    <i class="ace-icon fa fa-home home-icon"></i>
                    <a href="<?= site_url('SearchController/chemistryBsc1All');?>">Chemistry Bsc 1<sup>st</sup> Year Students</a>
                </li>
        ...
        <div class="page-content">
            <div class="page-header">
                ...
                <h1>Bsc 1 Year Chemistry 3rd Paper D Batch Students
                    <div class="dropdown pull-right responsive">
                        <button class="btn btn-primary dropdown-toggle btn-xs" type="button" data-toggle="dropdown">C-P-3
                            <span class="caret"></span></button>
                        <ul class="dropdown-menu">
                            <li><a href="<?= site_url('BatchController/chemistryBsc1P2A'); ?>">A</a></li>
                            <li><a href="<?= site_url('BatchController/chemistryBsc1P2B'); ?>">B</a></li>
                            <li><a href="<?= site_url('BatchController/chemistryBsc1P2C'); ?>">C</a></li>
                            <li><a href="<?= site_url('BatchController/chemistryBsc1P2D'); ?>">D</a></li>
                            <li><a href="<?= site_url('BatchController/chemistryBsc1P2E'); ?>">E</a></li>
                        </ul>
                    </div>
                </h1>
            </div><!-- /.page-header -->
