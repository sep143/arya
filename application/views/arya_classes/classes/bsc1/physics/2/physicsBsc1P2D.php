    ...
    <div class="main-content-inner">
        ...
        <div class="breadcrumbs ace-save-state responsive" id="breadcrumbs">
            <ul class="breadcrumb pull-left">
                ...
                <li>
                    <i class="ace-icon fa fa-home home-icon"></i>
                    <a href="<?= site_url('SearchController/physicsBsc1All');?>">Physics Bsc 1<sup>st</sup> Year Students</a>
                </li>
                <li>Physics Paper 2<sup>nd</sup> Students</li>
            </ul><!-- /.breadcrumb -->
        ...
        <div class="page-content">
            <div class="page-header">
                ...
                <h1>Bsc 1 Year Physics 2nd Paper D Batch Students
                     <div class="dropdown pull-right responsive">
                        <button class="btn btn-primary dropdown-toggle btn-xs" type="button" data-toggle="dropdown">P-P-2
                            <span class="caret"></span></button>
                        <ul class="dropdown-menu">
                            <li><a href="<?= site_url('BatchController/physicsBsc1P2A'); ?>">A</a></li>
                            <li><a href="<?= site_url('BatchController/physicsBsc1P2B'); ?>">B</a></li>
                            <li><a href="<?= site_url('BatchController/physicsBsc1P2C'); ?>">C</a></li>
                            <li><a href="<?= site_url('BatchController/physicsBsc1P2D'); ?>">D</a></li>
                            <li><a href="<?= site_url('BatchController/physicsBsc1P2E'); ?>">E</a></li>
                        </ul>
                    </div>
                </h1>
            </div><!-- /.page-header -->
