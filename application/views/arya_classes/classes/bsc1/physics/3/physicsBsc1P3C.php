    ...
    <div class="main-content-inner">
        ...
        <div class="page-content">
            <div class="page-header">
                ...
                <h1>Bsc 1 Year Physics 3rd Paper C Batch Students
                     <div class="dropdown pull-right responsive">
                        <button class="btn btn-primary dropdown-toggle btn-xs" type="button" data-toggle="dropdown">P-P-3
                            <span class="caret"></span></button>
                        <ul class="dropdown-menu">
                            <li><a href="<?= site_url('BatchController/physicsBsc1P3A'); ?>">A</a></li>
                            <li><a href="<?= site_url('BatchController/physicsBsc1P3B'); ?>">B</a></li>
                            <li><a href="<?= site_url('BatchController/physicsBsc1P3C'); ?>">C</a></li>
                            <li><a href="<?= site_url('BatchController/physicsBsc1P3D'); ?>">D</a></li>
                            <li><a href="<?= site_url('BatchController/physicsBsc1P3E'); ?>">E</a></li>
                        </ul>
                    </div>
                </h1>
            </div><!-- /.page-header -->
