    ...
    <div class="main-content-inner">
        ...
        <div class="breadcrumbs ace-save-state responsive" id="breadcrumbs">
            <ul class="breadcrumb pull-left">
                ...
                <li>
                    <i class="ace-icon fa fa-home home-icon"></i>
                    <a href="<?= site_url('SearchController/mathsBsc2All');?>">Maths Bsc 1<sup>st</sup> Year Students</a>
                </li>
        ...
        <div class="page-content">
            <div class="page-header">
                ...
                <h1>Bsc 2 Year Maths 1st Paper D Batch Students
                    <div class="dropdown pull-right responsive">
                        <button class="btn btn-primary dropdown-toggle btn-xs" type="button" data-toggle="dropdown">M-P-1
                            <span class="caret"></span></button>
                        <ul class="dropdown-menu">
                            <li><a href="<?= site_url('BatchController/mathsBsc2P1A'); ?>">A</a></li>
                            <li><a href="<?= site_url('BatchController/mathsBsc2P1B'); ?>">B</a></li>
                            <li><a href="<?= site_url('BatchController/mathsBsc2P1C'); ?>">C</a></li>
                            <li><a href="<?= site_url('BatchController/mathsBsc2P1D'); ?>">D</a></li>
                            <li><a href="<?= site_url('BatchController/mathsBsc2P1E'); ?>">E</a></li>
                        </ul>
                    </div>
                </h1>
            </div><!-- /.page-header -->
