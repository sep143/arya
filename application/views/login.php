...
<html lang="en">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Login Page - Arya Admin</title>
        ...
        <!-- ace styles -->
        <link rel="stylesheet" href="<?= base_url() ?>theme/assets/css/ace.min.css" />

        <!--[if lte IE 9]>
                <link rel="stylesheet" href="<?= base_url() ?>theme/assets/css/ace-part2.min.css" />
        <![endif]-->
    ...
    <body class="login-layout">
                        ...
                        <div class="login-container">
                            <div class="center">
                                <h1>
                                    ...
                                    <span class="white" id="id-text2">Record</span>
                                </h1>
                                <h4 class="blue" id="id-company-text">&copy; Arya Classes</h4>
                            </div>
                                            ...
                                            <form method="post" action="<?= site_url('LoginController/login'); ?>">
                                                <fieldset>
                                                    <label class="block clearfix">
                                                        ...
                                                        <div class="red"><?= form_error('user_name') ?></div>
                                                    </label>
                                                    <label class="block clearfix">
                                                        <span class="block input-icon input-icon-right">
                                ...
                                <div id="signup-box" class="signup-box widget-box no-border">
                                    <div class="widget-body">
                                        <div class="widget-main">
                                            ...
                                            <!--New User Register-->    <form method="post" action="<?= site_url('IndexController/register'); ?>">
                                                <fieldset>
                                                    <label class="block clearfix">
                                                        <span class="block input-icon input-icon-right">
                                                    ...
                                                    <label class="block clearfix">
                                                        <span class="block input-icon input-icon-right">
                                                            <input type="text" class="form-control" placeholder="Mobile" name="mobile" value="<?= set_value('mobile'); ?>" />
        ...
        <!--[if !IE]> -->
        <script src="<?= base_url() ?>theme/assets/js/jquery-2.1.4.min.js"></script>

        <!-- <![endif]-->

        <!--[if IE]>
<script src="<?= base_url() ?>theme/assets/js/jquery-1.11.3.min.js"></script>
<![endif]-->
        <script type="text/javascript">
            if ('ontouchstart' in document.documentElement)
                document.write("<script src='<?= base_url() ?>theme/assets/js/jquery.mobile.custom.min.js'>" + "<" + "/script>");
        </script>
